...
### Итого
|Микросервис\Запрос|Посты GET|Посты POST|Профиль GET|Профиль POST|Комментарии GET|Комментарии POST|Подписки|Лайки |Сумма |Пиковая (x2)|
|---		   |---	     |---	|---	    |---	 |---	         |--		  |---	   |---	  | ---  |---	      |
|API		   |10 069   |174	|3 472	    |1		 |16 782	 |3 356	          |115	   |16 782|50 751|101 502     |
|Auth		   |10 069   |174	|	    |1		 |		 |3 356		  |115	   |16 782|30 497|60 994      |
|Posts		   |10 069   |174	|3 472	    |		 |		 |3 356	          |	   |16 782|33 853|67 706      |
|Profile	   |	     |		|3 472	    |1		 |		 |	          |	   |	  |3 473 |6 946	      |
|Comments	   |10 069   |		|3 472	    |		 |16 782	 |3 356	          |	   |	  |33 679|67 358      |
|Likes		   |	     |		|	    |		 |		 |	          |	   |16 782|16 782|33 564      |
|Subscriptions	   |10 069   |		|3 472	    |		 |		 |	          |115	   |	  |13 656|27 312      |
