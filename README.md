...
Исходя из этих соображений будем считать, что для обеспечения 40 624 rps нам будет достаточно 33 cpu 128 RAM  
...
Согласно калькулятору для обеспечения на чтение 30323 rps и 3356 rps на запись нам хватит 12 core CPU, 13 Gb RAM  
Выбираем  
CPU: 16 core  
RAM: 16 Gb  
SSD: 4Tb Gb  
...
### Likes
Согласно калькулятору необходимо 12 CPU  
CPU: 16 core  
RAM: 16 Gb  
SSD: 8 Tb  
\+ 2 реплики  
...
|Auth  |16(2x8)	  |8	  |min	   |2 (+4)		   |
|Posts |32(2x16)  |128	  |4056	   |1 (+2)		   |
|Profile|8(2x4)	  |16	  |256	   |1 (+2)		   |
|Comments|16(2x8) |16	  |4056	   |1 (+2)		   |
|Likes |16(2x8)	  |16	  |8112	   |1 (+2)		   |
|Subscriptions|8(2x4)|16  |128     |1 (+2)                 |
